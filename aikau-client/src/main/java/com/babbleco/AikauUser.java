...
/**
 * <p>This is to all intents and purposes the same as the com.babbleco.web.site.SlingshotUser class that is used by the
...
public class AikauUser extends AlfrescoUser
{
    ...
    /**
     * @see com.babbleco.connector.User#save()
     */
    @Override
    public void save()
    {
